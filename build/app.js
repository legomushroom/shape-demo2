...
/***/ function(module, exports, __webpack_require__) {
	...
	var LINE2_SHIFT = 15;
	var LINE3_SHIFT = 20;
	var LINE1_SHIFT = 2 * LINE3_SHIFT;

	var LINE1_DURATION = 300;
	var LINE2_BOUNCE_DURATION = LINE1_DURATION / 2;
	var LINE3_BOUNCE_DURATION = LINE1_DURATION / 3;

	var COLLIDE_DURATION = .25 * LINE1_DURATION;
	var BOUNCE_DURATION = LINE1_DURATION - COLLIDE_DURATION;

	var CIRCLE_RADIUS = 50;
	var LINE_HEIGHT = 1.5 * CIRCLE_RADIUS;
	...
	var Demo = function (_Module) {
	  ...
	  */
	  ...
	  Demo.prototype._addCircle = function _addCircle(module) {
	    return new mojs.Shape((0, _extends3.default)({}, circleOpts, {
	      parent: module.el
	    }));
	  };
